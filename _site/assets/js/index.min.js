...
"use strict";$(document).ready(function(){function n(n,e){$(e).html(n)}function e(n,e){var s=n,i=Handlebars.templates[e],a=i(s);return a}function s(n,e,s,i){var a=s.find(n).data(e),o=i+a+".json";return o}function i(s,i,a){$.getJSON(s).then(function(n){return e(n,i)}).then(function(e){n(e,a)})}function a(s,i,a){$.getJSON(s).then(function(n){return e(n,i)}).then(function(e){n(e,a)}).then(function(){o()})}function o(){u.addClass("is-block"),setTimeout(function(){u.addClass("is-visible")},50),setTimeout(function(){d.addClass("is-in-position")},200)}function t(n,e,s,i){s.closest(n).find(e).removeClass(i).end().end().addClass(i)}function l(n,e,s){$(n).find(".languages-hidden").removeClass(s),$(e).addClass(s)}var c=$("nav"),u=$(".modal-overlay"),d=$(".modal-container"),g="../assets/json/languages/",r=$(".languagesNews__languages"),f=$("#1st"),m=$("#2nd"),v=$("#3rd"),h=function(){d.removeClass("is-in-position"),setTimeout(function(){u.removeClass("is-visible")},400),setTimeout(function(){u.removeClass("is-block")},600)};$(window).scroll(function(){var n=$(this).scrollTop(),e=$(".nav-logo"),s=c.height(),i=n>=s,a=n>=s+150;i?c.addClass("is-fixed"):c.removeClass("is-fixed"),a?e.addClass("logo-is-in-position"):e.removeClass("logo-is-in-position")});var C=function(){var n=$(this),e=n.parent().parent().find(".navigation"),s=e.find(".submenu"),i=s.hasClass("submenu-is-open"),a=n.find("svg");a.toggleClass("is-hidden"),i&&s.removeClass("submenu-is-open"),e.toggleClass("is-open")},p=function(){var n=$(window).width()<750,e=$(this);n&&e.find(".ch-down").toggleClass("is-hidden").end().find(".ch-up").toggleClass("is-hidden").end().find(".submenu").toggleClass("submenu-is-open")};c.on("click",".toggle-menu",C),c.on("click",".dropdown",p);var k=function(){var n=$(this),e=n.find("i").hasClass("notice-modal");if(e){var i=s(".notice-content","date",n,"../assets/json/news/cz/");a(i,"newTemplate","#modal-new")}},w=function(){var i=$(this),a=s("h3","category",i,g);t(f,".language-item",i,"is-picked"),$.getJSON(a).then(function(n){var s=e(n,"languageTemplate");return s}).then(function(e){var s="../assets/json/languages/starobyle.json",i=a===s;i?(n(e,v),l(r,v,"is-flex")):(n(e,m),l(r,m,"is-flex"))})},b=function(){var n=$(this),i=s("h4","category",n,g);t("#2nd",".language-item",n,"is-picked"),$.getJSON(i).then(function(n){var s=e(n,"languageTemplate");return s}).then(function(n){v.html(n).addClass("is-flex")})},T=function(){var n=$(".languages-hidden");n.removeClass("is-flex"),f.find(".language-item").removeClass("is-picked")},x=function(){var n=m.hasClass("is-flex");v.removeClass("is-flex"),n?m.find(".language-item").removeClass("is-picked"):f.find(".language-item").removeClass("is-picked")};i("../assets/json/news/notices.json","noticesTemplate","#news"),$("#news").on("click",".notice-flex",k),f.on("click",".language-item",w),m.on("click",".language-item",b),m.on("click",".languageTemplate__close",T),v.on("click",".languageTemplate__close",x),$(".modal").on("click",".close",h)});!function(){var a=Handlebars.template,n=Handlebars.templates=Handlebars.templates||{};n.languageTemplate=a({1:function(a,n,l,e,t){var s,i=null!=n?n:{},o=l.helperMissing,c="function",h=a.escapeExpression;return'<div class="language-item state-1">\n  <h4 data-category="'+h((s=null!=(s=l.data||(null!=n?n.data:n))?s:o,typeof s===c?s.call(i,{name:"data",hash:{},data:t}):s))+'" class="t-center">'+h((s=null!=(s=l.language||(null!=n?n.language:n))?s:o,typeof s===c?s.call(i,{name:"language",hash:{},data:t}):s))+"</h3>\n</div>\n"},compiler:[7,">= 4.0.0"],main:function(a,n,l,e,t){var s,i,o=null!=n?n:{};return'<div class="languageContainer">\n  <header class="languageContainer__header">\n  <h3 class="languageContainer__title">'+a.escapeExpression((i=null!=(i=l.languages||(null!=n?n.languages:n))?i:l.helperMissing,"function"==typeof i?i.call(o,{name:"languages",hash:{},data:t}):i))+'</h3>\n  <div class="languageTemplate__close">\n    <svg fill="#FFFFFF" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">\n      <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n      <path d="M0 0h24v24H0z" fill="none"></path>\n    </svg>\n  </div>\n</header>\n\n\n'+(null!=(s=l.each.call(o,null!=n?n.items:n,{name:"each",hash:{},fn:a.program(1,t,0),inverse:a.noop,data:t}))?s:"")+"\n<div>\n"},useData:!0}),n.lectorTemplate=a({compiler:[7,">= 4.0.0"],main:function(a,n,l,e,t){var s,i=null!=n?n:{},o=l.helperMissing,c="function",h=a.escapeExpression;return'\n<div class="modal-item-40">\n  <figure><img src="'+h((s=null!=(s=l.image||(null!=n?n.image:n))?s:o,typeof s===c?s.call(i,{name:"image",hash:{},data:t}):s))+'"/></figure>\n</div>\n<div class="modal-item-60">\n  <h2 class="modal__title">'+h((s=null!=(s=l.name||(null!=n?n.name:n))?s:o,typeof s===c?s.call(i,{name:"name",hash:{},data:t}):s))+'</h2>\n  <h3 class="modal__subtitle">'+h((s=null!=(s=l.lectorOf||(null!=n?n.lectorOf:n))?s:o,typeof s===c?s.call(i,{name:"lectorOf",hash:{},data:t}):s))+'</h3>\n  <p class="modal__content">'+h((s=null!=(s=l.about||(null!=n?n.about:n))?s:o,typeof s===c?s.call(i,{name:"about",hash:{},data:t}):s))+'</p>\n  <p class="modal__content"><span class="text-highlight">Vzdělání: </span>'+h((s=null!=(s=l.education||(null!=n?n.education:n))?s:o,typeof s===c?s.call(i,{name:"education",hash:{},data:t}):s))+'</p>\n</div>\n<div class="close">\n  <svg fill="#FFFFFF" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">\n    <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n    <path d="M0 0h24v24H0z" fill="none"></path>\n  </svg>\n</div>\n'},useData:!0}),n.newTemplate=a({1:function(a,n,l,e,t){var s,i=null!=n?n:{},o=l.helperMissing,c="function",h=a.escapeExpression;return'  <a href="'+h((s=null!=(s=l.link||(null!=n?n.link:n))?s:o,typeof s===c?s.call(i,{name:"link",hash:{},data:t}):s))+'" class="modal-btn">\n    '+h((s=null!=(s=l.linkInfo||(null!=n?n.linkInfo:n))?s:o,typeof s===c?s.call(i,{name:"linkInfo",hash:{},data:t}):s))+' <i class="fa fa-angle-right"></i></a>\n'},compiler:[7,">= 4.0.0"],main:function(a,n,l,e,t){var s,i,o=null!=n?n:{},c=l.helperMissing,h="function",u=a.escapeExpression;return'\n<div class="modal-item-100 flex">\n  <h2 class="modal_title-small">'+u((i=null!=(i=l.headline||(null!=n?n.headline:n))?i:c,typeof i===h?i.call(o,{name:"headline",hash:{},data:t}):i))+'</h2>\n  <h3 class="modal__date">'+u((i=null!=(i=l.date||(null!=n?n.date:n))?i:c,typeof i===h?i.call(o,{name:"date",hash:{},data:t}):i))+'</h3>\n  <p class="modal__content">'+u((i=null!=(i=l.content||(null!=n?n.content:n))?i:c,typeof i===h?i.call(o,{name:"content",hash:{},data:t}):i))+"</p>\n"+(null!=(s=l["if"].call(o,null!=n?n.link:n,{name:"if",hash:{},fn:a.program(1,t,0),inverse:a.noop,data:t}))?s:"")+'</div>\n<div class="close">\n  <svg fill="#FFFFFF" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">\n    <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>\n    <path d="M0 0h24v24H0z" fill="none"></path>\n  </svg>\n</div>\n'},useData:!0}),n.noticesTemplate=a({1:function(a,n,l,e,t){var s;return'<li class="notice-flex">\n'+(null!=(s=l["if"].call(null!=n?n:{},null!=n?n.link:n,{name:"if",hash:{},fn:a.program(2,t,0),inverse:a.program(4,t,0),data:t}))?s:"")+"</li>"},2:function(a,n,l,e,t){var s,i=null!=n?n:{},o=l.helperMissing,c="function",h=a.escapeExpression;return'	<i class="fa fa-angle-right notice-link"></i><a class="notice__link" href="'+h((s=null!=(s=l.link||(null!=n?n.link:n))?s:o,typeof s===c?s.call(i,{name:"link",hash:{},data:t}):s))+'"> <p class="notice-content">'+h((s=null!=(s=l.notice||(null!=n?n.notice:n))?s:o,typeof s===c?s.call(i,{name:"notice",hash:{},data:t}):s))+"</p></a>\n"},4:function(a,n,l,e,t){var s,i=null!=n?n:{},o=l.helperMissing,c="function",h=a.escapeExpression;return'	<i class="fa fa-angle-right notice-modal"></i><p data-date="'+h((s=null!=(s=l.date||(null!=n?n.date:n))?s:o,typeof s===c?s.call(i,{name:"date",hash:{},data:t}):s))+'" class="notice-content"></i>'+h((s=null!=(s=l.notice||(null!=n?n.notice:n))?s:o,typeof s===c?s.call(i,{name:"notice",hash:{},data:t}):s))+"</p></a>\n"},compiler:[7,">= 4.0.0"],main:function(a,n,l,e,t){var s;return(null!=(s=l.each.call(null!=n?n:{},null!=n?n.shortNotices:n,{name:"each",hash:{},fn:a.program(1,t,0),inverse:a.noop,data:t}))?s:"")+"\n"},useData:!0})}();
